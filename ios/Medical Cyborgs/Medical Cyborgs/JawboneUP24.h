...
//  Medical Cyborgs
//
//  Created by Douglas Gardiner on 11/28/14.
...
extern NSString * const UP24_SERV_UUID;

@interface JawboneUP24 : NSObject <DeviceCommonInfoInterface, ActivityMonitorProtocol>
