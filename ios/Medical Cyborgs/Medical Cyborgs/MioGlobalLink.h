...
//
/**
 * This class is for the Wahoo Mio Global Link wristband device.  Device specific UUIDs for services
...
@interface MioGlobalLink : NSObject <DeviceCommonInfoInterface, HeartMonitorProtocol>
